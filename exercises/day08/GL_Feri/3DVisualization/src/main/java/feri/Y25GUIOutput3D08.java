...
public class Y25GUIOutput3D08 extends Application {
	...
	public Y25GUIOutput3D08(String title, boolean useCachedNodes) {
		this.title = title;
...
//    			refreshCanvas();
	...
	public static void main(String[] args) throws Exception {
		Y25GUIOutput3D08 output = new Y25GUIOutput3D08("GUIOutput3D Test", true);
		output.smaller();
